package com.hotel.management.common.config;
...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.consumer.group-id:hotel-management-group}")
    ...
    @Bean
    public NewTopic housekeepingEventsTopic() {
        return TopicBuilder.name("housekeeping-events")
                .partitions(3)
                .replicas(1)
                .build();
    }
    ...
    @Bean
    public NewTopic staffEventsTopic() {
        return TopicBuilder.name("staff-events")
                .partitions(3)
                .replicas(1)
                .build();
    }
